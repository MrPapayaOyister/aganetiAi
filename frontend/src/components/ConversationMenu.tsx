          ...
          <>
            ...
            >
              <button
                ...
                className="w-full flex items-center gap-2 px-3 h-9 rounded-lg t-label text-[#38DBFF] hover:bg-white/[0.04]"
              >
              ...
              {sessions.map(s => (
                ...
                >
                  ...
                  <button
                    ...
                    className="opacity-0 group-hover:opacity-100 text-[#5C6B85] hover:text-[#FF4466] transition-opacity"
                    title="Delete"
                  >
                    <Trash2 size={13} />
                  </button>
